      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <NavGroup title="Social">
            <NavLink href="https://www.instagram.com/mo.nkey2783/">Instagram</NavLink>
            <NavLink href="https://x.com/kriplanijj">X (Twitter)</NavLink>
            <NavLink href="https://www.facebook.com/jayesh.kriplani.984/">Facebook</NavLink>
          </NavGroup>
        </div>
